...
class Music(commands.Cog):
    ...
    async def _help(self, ctx:commands.context):
        ...
        embed.set_thumbnail(url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Anonymous_emblem.svg/320px-Anonymous_emblem.svg.png")
        ...
        embed.add_field(name="air" ,value="When you're not sure if your sentence is grammatically correct",inline=False)
        embed.add_field(name="korean" ,value="When you want to know Korean meanings of English words",inline=False)                      
        embed.add_field(name="english" ,value="When you want to know English meanings of Korean words",inline=False)
        embed.add_field(name="grammar" ,value="When you have a question about English grammar (e.g. tenses and voices)",inline=False)
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name='\'불합격 소식\''))
